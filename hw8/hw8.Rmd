---
title: "Hw8"
author: "Joe Stoica, Corey Maxedon"
date: "12/3/2019"
output: pdf_document
---
...
contagion_sim <- function(p, network, nodes, steps) {
  ...
  for (step in 2:steps) {
    ...
    for(i in 1:nrow(infected_df)){
      # TODO add if a doctor is already infected, don't overwrite previous step
